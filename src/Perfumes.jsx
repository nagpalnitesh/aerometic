    ...
    return (
        <>
            ...
            <div className="container-fluid about">
                ...
                experienced perfume manufacturer in Ahmedabad, we are endowed with all the necessary infrastructural andprocessing capabilities to offer the best and most comprehensive private label perfume manufacturing service.
                You can communicate your specifications, the desired quality standards and quantity of your products and we
                will do the rest. </p>
                <p>We have a range of fragrance manufacturing units and facilities, integrated effectively with
                state-of-the-art equipment to carefully create the scents you need, irrespective of the size and scope you need it
                for. We have exceptionally trained and experienced professionals who can create and assist with even the most
                demanding and complexing requirements you might have. In order to ensure that the clients always get the best
                products from us, we have incorporated several International and Industry Standardizations. Though we make
                use of several advanced processes, equipment, and quality standards, we always make our products affordable
                to all our clients. We are always on the look out to create the best service propositions for our clients in order to
make them happy and long cherished customers of our products.</p>
                <p style={{ fontStyle: 'italic' }}>Aerometic ’s scale and quality of production can exceed all expectations.</p>
                <p>
                    Our manufacturing plant produces several products for leading fashion brands in International markets. Our
                    expertise in this field will ensure your product and brand ideas are executed with exactitude and finesse.
                </p>
                <p style={{ fontStyle: 'italic' }}>A personal touch for a signature scent.</p>
                <p>Our cutting edge factory can produce high quality bespoke fragrances in the desired volume. This high level of
                personalization can contribute infinitely towards your branding goals or event. Our unambiguously limited
                production runs can accommodate large scale events, corporate gifting, retail outlet or weddings, complete with
individually tailored scent, gift boxing or packaging.</p>

                <p>Aerometic is the heart of all inventive vision in the company. Our products are conceptualized by our creative
                team and rigorously tested in our labs by our technicians. We have a proud family of veteran personnel across
                various teams and departments. Our highly driven board of Directors who have more than 20 years of
                excellence in the international industry and have envisioned a trailblazing path for Aerometic . From our
                governing board to our assembly staff, our strong ethical practices place sustainability and corporate
                responsibility foremost. Aerometic began its journey with an aspiringly simple ethos: " To ensure every single
                fragrance curated by Aerometic is the ultimate expression of the wearer. Every spray will encapsulate our
                ...
                <div className="row">
                    <div className="col-md-4">
                        <ul className="prolist">
                            <li><img src={Spray} alt="" /><span>Parfum</span></li>
                            <li><img src={Spray} alt="" /><span>Eau De Parfum</span></li>
                            <li><img src={Spray} alt="" /><span>Eau De Toilette</span></li>
                            <li><img src={Spray} alt="" /><span>Eau De Cologne</span></li>
                            <li><img src={Spray} alt="" /><span>Eau Fraiche</span></li>
                        </ul>
                    </div>
                    <div className="col-md-4">
                        <ul className="prolist">
                            <li><img src={Spray} alt="" /><span>Body Mists</span></li>
                            <li><img src={Spray} alt="" /><span>Scented Warmer Oils</span></li>
                            <li><img src={Spray} alt="" /><span>Non Alcoholic Attar</span></li>
                            <li><img src={Spray} alt="" /><span>Non Alcoholic Perfume</span></li>
                            <li><img src={Spray} alt="" /><span>Perfume Roll-On</span></li>
                        </ul>
                    </div>
                    <div className="col-md-4">
                        <ul className="prolist">
                            <li><img src={Spray} alt="" /><span>Pocket Perfumes</span></li>
                            <li><img src={Spray} alt="" /><span>Perfume Vials</span></li>
                            <li><img src={Spray} alt="" /><span>Perfume Pen Spray</span></li>
                        </ul>
                    </div>
                </div>
            </div>
