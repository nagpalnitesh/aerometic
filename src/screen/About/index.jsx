                ...
                <div className="mainAbout">
                    ...
                    <div className="mainAboutTxt">
                        ...
                        <p data-aos="fade-left" data-aos-duration="2000">
                            <strong>
                                PERFUMES:
                            </strong> Parfum, Eau de Toilette, Eau de Cologne, After Shave.
                        </p>
                        <p data-aos="fade-left" data-aos-duration="2000">
                            <strong>
                                AEROSOLS:
                            </strong> Deodorants, Body Spray, Air Fresheners, Disinfectant Spray.
                        </p>
                        <p data-aos="fade-left" data-aos-duration="2000">
                            <strong>
                                PERSONAL CARE:
                            </strong> Moisturizing Cream, Face Wash, Soaps, Shower & Bath Gel, Lotions, Hand Wash, Hand Sanitizer.
                        </p>
                        <p data-aos="fade-left" data-aos-duration="2000">
                            <strong>
                                HAIR CARE:
                            </strong> Hair Oils, Hair Shampoo & Conditioner.
                        </p>
                        <h1 data-aos="fade-right" data-aos-duration="2000">
                            Our Amenities
                        </h1>
                        ...
                        <p data-aos="fade-left" data-aos-duration="2000">
                            Our Quality Service consists of the following process:
                        </p>
                        <div className="row">
